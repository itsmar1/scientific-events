...
export default {
  ...
  computed: {
    sessionAdmins() {
      return this.$store.getters["responsable/sessionAdmins"];
    },

  },
  methods: {
    async getSessionAdmins() {
      await this.$store.dispatch('responsable/getSessionAdmins');
    },
    updateUser(payload){
        this.$store.dispatch('responsable/putSessionAdmins', {
            user: payload,
            id: payload.id
        });
    },
    deleteUser(id) {
        this.$store.dispatch('responsable/deleteSessionAdmins', id);
    },
    async addUser() {
        await this.$store.dispatch('responsable/postSessionAdmins', this.user);
    }
  },
  mounted() {
