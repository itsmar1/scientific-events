...
export default {
  ...
  computed: {
    responsables() {
      return this.$store.getters["eventadmin/responsables"];
    },

  },
  methods: {
    async getResponsable() {
      await this.$store.dispatch('eventadmin/getResponsable');
    },
    updateUser(payload){
        this.$store.dispatch('eventadmin/putResponsable', {
            user: payload,
            id: payload.id
        });
    },
    ...
    // },
    deleteUser(id) {
        this.$store.dispatch('eventadmin/deleteResponsable', id);
    },
    async addUser() {
        await this.$store.dispatch('eventadmin/postResponsable', this.user);
    }
  },
  mounted() {
    this.getResponsable();
