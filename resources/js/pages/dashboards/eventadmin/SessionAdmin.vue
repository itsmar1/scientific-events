...
export default {
  ...
  computed: {
    sessionAdmins() {
      return this.$store.getters["eventadmin/sessionAdmins"];
    },

  },
  methods: {
    async getSessionAdmins() {
      await this.$store.dispatch('eventadmin/getSessionAdmins');
    },
    updateUser(payload){
        this.$store.dispatch('eventadmin/putSessionAdmins', {
            user: payload,
            id: payload.id
        });
    },
    deleteUser(id) {
        this.$store.dispatch('eventadmin/deleteSessionAdmins', id);
    },
    async addUser() {
        await this.$store.dispatch('eventadmin/postSessionAdmins', this.user);
    }
  },
  mounted() {
